...
INSERT INTO site_content (content_key, category, value_fr, value_ar) VALUES
  ...
  ('cart.emptyText', 'cart', 'Découvrez nos packs de parfums curés avec soin.', 'اكتشفوا باقات عطورنا المنتقاة بعناية.'),
  ('cart.exploreBtn', 'cart', 'Explorer les packs', 'استكشفوا الباقات'),
...
INSERT INTO site_content (content_key, category, value_fr, value_ar) VALUES
  ...
  ('checkout.exploreBtn', 'checkout', 'Explorer les packs', 'استكشفوا الباقات'),
