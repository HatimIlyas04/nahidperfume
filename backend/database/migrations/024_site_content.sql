...
INSERT INTO site_content (content_key, category, value_fr, value_ar) VALUES
  ...
  ('cart.total', 'cart', 'Total', 'الإجمالي'),
  ...
  ('checkout.total', 'checkout', 'Total', 'الإجمالي'),
...
INSERT INTO site_content (content_key, category, value_fr, value_ar) VALUES
  ...
  ('thankYou.totalLabel', 'thankYou', 'Total', 'الإجمالي'),
  ...
  ('thankYou.upsellSectionSubtitle', 'thankYou', 'Disponible uniquement maintenant, avec votre commande', 'بما أنك أكدتِ طلبك الأول، يمكنك إضافة باقة ثانية من اختيارك بـ 150 درهم فقط، والتوصيل مجاني.'),
  ('thankYou.upsellBadge', 'thankYou', 'Offre spéciale', 'عرض خاص'),
  ('thankYou.upsellFreeDelivery', 'thankYou', 'Livraison gratuite', 'التوصيل مجاني'),
