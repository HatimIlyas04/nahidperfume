...
CREATE TABLE IF NOT EXISTS order_item_perfumes (
  ...
  perfume_inspired_by_snapshot    VARCHAR(255) NULL,
  perfume_concentration_snapshot  VARCHAR(100) NULL,
  perfume_size_snapshot           VARCHAR(20) NULL,
  perfume_gender_snapshot         VARCHAR(20) NULL,
