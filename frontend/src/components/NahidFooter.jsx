...
const NahidFooter = () => {
  ...
  const [waDisplay, setWaDisplay] = useState("0636572200");
  useEffect(() => {
    settingsApi.getPublic().then((s) => {
      if (s.contact_whatsapp) {
        setWaLink(whatsAppLink(s.contact_whatsapp));
        setWaDisplay(s.contact_whatsapp);
      }
    }).catch(() => {});
  }, []);
        ...
        <div className="nf-grid">
          ...
          <div className="nf-brand">
            ...
            <div className="nf-social">
              ...
              <a href={waLink} target="_blank" rel="noopener" className="nf-social-btn wa" aria-label="WhatsApp">
          ...
          <div>
            ...
            <a href={waLink} target="_blank" rel="noopener" className="nf-contact-item">
