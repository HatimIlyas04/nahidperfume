...
.fp-q { width: 100%; text-align: start; background: none; border: none; padding: 22px 0; display: flex; justify-content: space-between; align-items: center; cursor: pointer; font-size: 1rem; font-weight: 600; color: var(--secondary); font-family: var(--font-body); }
.fp-a { padding: 0 0 22px; color: var(--text-light); font-size: 0.9rem; line-height: 1.65; max-width: 680px; }
.fp-plus { font-size: 1.4rem; color: var(--primary); transition: transform 0.25s; flex-shrink: 0; margin-inline-start: 16px; }
